(function () {
    ...
    /*
     userRatings
     */
    userRatings.$inject = ['$rootScope'];
    function userRatings ($rootScope) {
        return {
            restrict: 'E',
            scope: {
                user: '='
            },
            templateUrl: $rootScope.viewPath('users/directives/user-ratings.html')
        }
    }
    ...
    /*
     UserFeedbackCtrl
     */
    UserFeedbackCtrl.$inject = ['$mdDialog', '$mdMedia', 'UsersService', 'user', 'distance', 'onfeedbackclose', '$rootScope'];
    function UserFeedbackCtrl($mdDialog, $mdMedia, UsersService, user, distance, onfeedbackclose, $rootScope) {
        var self = this;
     ...
     */
    userPhotoRatingsDistance.$inject = ['$rootScope'];
    function userPhotoRatingsDistance ($rootScope) {
        var controller = ['$scope', '$mdMedia', '$mdDialog', '$rootScope', function ($scope, $mdMedia, $mdDialog, $rootScope) {
            var useFullScreen = ($mdMedia('sm') || $mdMedia('xs'));
            $scope.showUserFeedback = function (user, onfeedbackclose) {
                $mdDialog.show({
                    ...
                    templateUrl: $rootScope.viewPath('users/user.feedback.html'),
                    parent: angular.element(document.body),
                    clickOutsideToClose: true,
                    fullscreen: useFullScreen
                });
        ...
        return {
            ...
            templateUrl: $rootScope.viewPath('users/directives/user-photo-ratings-distance.html')
        }
    }
    ...
    /*
     userRecentFeedback
     */
    userRecentFeedback.$inject = ['$rootScope'];
    function userRecentFeedback ($rootScope) {
        return {
            restrict: 'E',
            scope: {
                user: '=',
            ...
            templateUrl: $rootScope.viewPath('users/directives/user-recent-feedback.html')
        }
    }
